...
$tsql = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY ManufactureID)  AS RowNumber,  ManufactureName,   ManufactureType, ManufactureShortName, ManufactureUnder, ManufactureOrder, ManufactureAddress1, ManufactureAddress2, ManufactureCity, ManufactureDistrict, ManufactureState, ManufacturePincode, ManufactureSM, Manufacture_SMPhone  FROM dbo.Manufactures)  AS Temp WHERE RowNumber BETWEEN ? AND ?"; 
    ...
    <div class="container">
      ...
      <thead>
        ...
        <tr>          
          ...
          <th>ManufactureType</th>
          <th>ManufactureShortName</th>
          <th>ManufactureUnder</th>
          <th>ManufactureOrder</th>
          <th>ManufactureAddress1</th>
          <th>ManufactureAddress2</th>
          <th>ManufactureCity</th>
          <th>EachStripQuantity</th>
          <th>ManufactureDistrict</th>
          <th>ManufactureState</th>
          <th>ManufacturePincode</th>
          <th>ManufactureSM</th>
          <th>Manufacture_SMPhone</th>
        </tr>
      </thead>
      <tbody>
        <?php print $data_rows; ?>
