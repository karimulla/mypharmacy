...
$distributor_names = ""; 
$tsql0 = "SELECT Name FROM dbo.SalesMen"; 
  ...
  <body>
    ...
    <div class="container">
      <div class="starter-template">
        ...
        <div class="row">
          <div class="col-md-10">
          <form action="report-operator-sales.php">
            From:
